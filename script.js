$(document).ready(function() {
    $('#input_h3_1').click(function() {
		...
		$('.output').prepend("<li class=">Considering the density of nitrogen in the Chesapeake bay is 5mg/L of water, it would take between " + w_output_val_l_2 + " and " + w_output_val_h_2 + " oysters " + input_val + " years to clean the Bay completely with its current amount of pollution and its continued rate of pollution.</li>")
	});
